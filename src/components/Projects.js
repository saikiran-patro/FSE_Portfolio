...
const Projects = () => {
   ...
   const typeNavigationHeight=typeNavigation.current?.getBoundingClientRect().height;
   const projectsContainerWidth=projectsContainer.current?.getBoundingClientRect().width
  useEffect(()=>{
  ...
  }, [navBarElement,typeNavigationHeight,projectsContainerWidth])
